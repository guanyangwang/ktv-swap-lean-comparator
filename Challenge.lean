...
spectral-gap theorem. These definitions are included directly in the challenge
so that the challenge can be compiled in isolation.
-/
...
/--
Comparator challenge for the Mathlib-only statement of the fixed-margin
lazy swap-chain spectral-gap theorem.
-/
